...
#endif
            VL_FATAL_MT("src/kianv_harris_pipelined_edition.sv", 16, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("src/kianv_harris_pipelined_edition.sv", 16, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("src/kianv_harris_pipelined_edition.sv", 16, "", "Active region did not converge.");
            }
